...
class MeanIoU:
    ...
    def update(self, outputs, targets):
        ...
        print(f'miou.output.shape: {outputs.shape}')
        print(f'miou.targets.shape: {targets.shape}')
    ...
    def get_iou(self):
        # for i in range(self.num_classes):
        #     self.total_seen[i] = ops.AllReduce()(self.total_seen[i])
        #     self.total_correct[i] = ops.AllReduce()(self.total_correct[i])
        #     self.total_positive[i] = ops.AllReduce()(self.total_positive[i])
