...
class MinkUNet(nn.Cell):
    def __init__(self, **kwargs):
        ...
        self.classifier = nn.SequentialCell(nn.Dense(cs[8], kwargs['num_classes']))
    ...
    def weight_initialization(self):
        for m in self.modules():
            if isinstance(m, nn.BatchNorm1d):
                mindspore.common.initializer.Constant(value=1)(m.weight)
                mindspore.common.initializer.Constant(value=0)(m.bias)
