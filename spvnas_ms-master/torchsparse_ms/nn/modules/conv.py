...
class Conv3d(nn.Cell):
    ...
    def __init__(self,
        ...
        if self.kernel_volume > 1:
            ...
            # self.kernel_torch = nn_torch.Parameter(
            ...
            # self.kernel_torch = nn_torch.Parameter(torch.zeros(in_channels, out_channels))
        if bias:
    ...
    def reset_parameters(self, weight) -> None:
        ...
        self.kernel = mindspore.Tensor(Parameter(weight.detach().cpu().numpy()), mindspore.float32)
