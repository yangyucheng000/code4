...
def bprop():
    ...
    sp_devoxelize_backward = ops.Custom(
        "./torchsparse_ms/nn/cuda/devoxelize/devoxelize_cuda.so:devoxelize_backward_ms",
...
class SPDevoxelizeForward(Cell):
    def __init__(self, ):
        ...
        self.spdevoxelize = ops.Custom("./torchsparse_ms/nn/cuda/devoxelize/devoxelize_cuda.so:devoxelize_forward_ms",
...
class SPDevoxelizeBackward(Cell):
    def __init__(self, ):
        ...
        self.spdevoxelize = ops.Custom("./torchsparse_ms/nn/cuda/devoxelize/devoxelize_cuda.so:devoxelize_backward_ms",
                                       out_shape=infer_func,
                                       out_dtype=infer_func,
                                       func_type="aot")
...
if __name__ == '__main__':
    os.environ["MS_CUSTOM_AOT_WHITE_LIST"] = "./torchsparse_ms/nn/cuda"
