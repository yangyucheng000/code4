...
class SPHash(Cell):
    def __init__(self,):
        ...
        self.sphash = ops.Custom("torchsparse_ms/nn/cuda/hash/hash_cuda.so:hash_ms",
                                      out_shape=infer_func1,
                                      out_dtype=infer_func1,
                                      func_type="aot",
                                      reg_info=hash_cuda_info)

        self.spkernelhash = ops.Custom("torchsparse_ms/nn/cuda/hash/hash_cuda.so:kernel_hash_ms",
