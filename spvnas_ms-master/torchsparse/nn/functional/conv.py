...
class ConvolutionFunction(Function):
    ...
    def forward(ctx,
        ...
        if input.device.type == 'cuda':
            ...
            print("nbsizes: \n", nbsizes)
            print("nbsizes_shape: ", nbsizes.shape)
            print("transposed: \n", transposed)
            output_ori = output
            ...
            print("------------------------------")
            print("save data: ")
            np.savez('/home/ubuntu/hdd1/ylc/codes/torchsparse-1.4.0/examples/conv_sample.npz',
                     input=input.cpu().numpy(), output=output_ori.cpu().numpy(),
                     weight=weight.cpu().numpy(), nbmaps=nbmaps.cpu().numpy(),
                     nbsizes=nbsizes.cpu().numpy(), transposed=transposed,
