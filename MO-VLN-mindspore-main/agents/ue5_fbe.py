...
from mindspore.dataset.vision import ToPIL, Resize, Inter
...
from agents.utils.clip_prediction import SemanticPredCLIP
...
class UE5_FBE_Env_Agent(ObjectGoalEnv):
    ...
    def _preprocess_obs(self, obs, use_seg=True):
        ...
        if ds != 1:
            rgb = np.asarray(self.res(rgb.astype(np.uint8))[0])
    ...
    def _visualize(self, inputs):
        ...
        self.vis_image[50:530, 15:655] = self.rgb_vis.transpose(1, 0, 2)
    ...
    def get_camera_parameters(self):
        param_dict = {
            ...
            'fx': self.fx,
            'fy': self.fy,
            'matrix': Tensor.from_numpy(self.matrix).float()
        }
        return param_dict
