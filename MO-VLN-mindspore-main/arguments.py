...
def get_args():
    ...
    parser.add_argument('--sem_seg_model_type', type=str, default='clip',
                        help="use different model for detection (clip)")
    parser.add_argument(
    ...
    parser.add_argument(
        "--co_occurence_type", default="GPT4", type=str, help="GPT4, chatGPT"
    )
    parser.add_argument('--task', type=str, default='objectnav', choices=['objectnav', 'reasoning', 'simple', 'vln'])
    parser.add_argument('--reasoning_type', type=str, help='GPT4, chatGPT, vicuna7b, vicuna13b')
    parser.add_argument('--with_vln_action', type=int, default=0, help='0: w/o action, 1: w/ action')
    ...
    if args.map_id == 3:
        ...
        args.seg_categories_id_file = 'dataset/objectnav/Starbucks_seg_categories_id.json'
        ...
        args.seg_categories_id_file = 'dataset/objectnav/TG_seg_categories_id.json'
        ...
        args.seg_categories_id_file = 'dataset/objectnav/NursingRoom_seg_categories_id.json'
        args.max_episode_length = 2000
